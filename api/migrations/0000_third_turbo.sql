...
ALTER TABLE IF EXISTS basemaps
    ALTER COLUMN id TYPE INTEGER;
ALTER TABLE IF EXISTS connection_sinks
    ALTER COLUMN id TYPE INTEGER;
ALTER TABLE IF EXISTS connections
    ALTER COLUMN id TYPE INTEGER;
ALTER TABLE IF EXISTS data
    ALTER COLUMN id TYPE INTEGER;
ALTER TABLE IF EXISTS data_mission
    ALTER COLUMN id TYPE INTEGER;
ALTER TABLE IF EXISTS icons
    ALTER COLUMN id TYPE INTEGER;
ALTER TABLE IF EXISTS layer_alerts
    ALTER COLUMN id TYPE INTEGER;
...
ALTER TABLE IF EXISTS icons
    ALTER COLUMN updated TYPE TIMESTAMPTZ;
ALTER TABLE IF EXISTS iconsets
    ALTER COLUMN created TYPE TIMESTAMPTZ;
ALTER TABLE IF EXISTS iconsets
    ALTER COLUMN updated TYPE TIMESTAMPTZ;
...
ALTER TABLE IF EXISTS connection_sinks
    ALTER COLUMN connection TYPE INTEGER;
ALTER TABLE IF EXISTS layers
    ALTER COLUMN data TYPE INTEGER;
ALTER TABLE IF EXISTS data_mission
    ALTER COLUMN data TYPE INTEGER;
ALTER TABLE IF EXISTS layers
    ALTER COLUMN schema TYPE JSON;
ALTER TABLE IF EXISTS layers
    ALTER COLUMN environment TYPE JSON;
ALTER TABLE IF EXISTS profile_overlays
    ALTER COLUMN mode_id TYPE INTEGER;
ALTER TABLE IF EXISTS profile
