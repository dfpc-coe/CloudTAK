...
CREATE TABLE "core_event_board_event" (
...
ALTER TABLE "core_event_board_event" ADD CONSTRAINT "core_event_board_event_event_core_event_id_fk" FOREIGN KEY ("event") REFERENCES "public"."core_event"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "core_event_board_channel_idx" ON "core_event_board" USING btree ("channel");