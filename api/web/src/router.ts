    ...
    routes: [
        {
            ...
            children: [{
                ...
                children: [{
                    ...
                    path: 'history',
                    name: 'home-menu-history',
                    component: () => import('./components/CloudTAK/Menu/MenuHistory.vue')
                },{
                    path: 'chats',
        ...
        // Intentionally not a dynamic import to ensure it's included in the build
