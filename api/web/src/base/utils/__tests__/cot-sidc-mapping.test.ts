...
describe('CoT to SIDC Mapping', () => {
    ...
    test('should correctly identify mapped CoT types', () => {
        expect(hasSidcMapping('a-f-S-X-M-T')).toBe(true);
...
describe('Icon Utils', () => {
    test('should identify icon source types correctly', () => {
        expect(getIconSourceType('a-f-S-X-M-T')).toBe('cot-sidc');
    ...
    test('should get SIDC codes correctly', () => {
        expect(getIconSidc('a-f-S-X-M-T')).toBe('130330000014011100000000000000');
    ...
    test('should identify generatable icons', () => {
        expect(canGenerateIcon('a-f-S-X-M-T')).toBe(true);
