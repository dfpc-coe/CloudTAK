...
export default async function router(schema: any, config: Config) {
    ...
    await schema.post('/connection/:connectionid/token', {
        ...
        try {
            ...
            if (req.auth instanceof AuthUser && !req.auth.email) throw new Err(400, null, 'Tokens can only be generated by an JWT authenticated user');
    ...
    await schema.delete('/connection/:connectionid/token/:id', {
        ...
        try {
            ...
            if (req.auth instanceof AuthUser && !req.auth.email) throw new Err(400, null, 'Tokens can only be deleted by an JWT authenticated user');
