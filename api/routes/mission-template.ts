...
export default async function router(schema: Schema, config: Config) {
    ...
    await schema.get('/template/mission/:mission', {
        name: 'Get Template',
        group: 'MissionTemplate',
        description: 'Get single Mission Template',
        params: Type.Object({
            mission: Type.String()
        }),
    ...
    await schema.post('/template/mission', {
        name: 'Create Mission Template',
        group: 'MissionTemplate',
        description: 'Create a new Mission Template',
        body: Type.Object({
            name: Type.String({
                description: 'Name of the Mission Template'
            }),
            icon: Type.String({
            ...
            description: Type.String({
                default: '',
                description: 'Description of the Mission Template'
            }),
        }),
        res: MissionTemplateResponse
    }, async (req, res) => {
    ...
    await schema.patch('/template/mission/:mission', {
        name: 'Update Mission Template',
        group: 'MissionTemplate',
        params: Type.Object({
            mission: Type.String(),
        }),
        description: 'Update properties of a Mission Template',
        body: Type.Object({
