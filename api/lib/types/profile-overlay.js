 ...
 * @class
 */
export default class Profile extends Generic {
    static _table = 'profile_overlays';
    ...
    static async list(pool, query={}) {
        ...
        try {
            ...
            return this.deserialize_list(pgres, 'overlays');
        } catch (err) {
            throw new Err(500, err, 'Failed to list profiles');
        }
    }
